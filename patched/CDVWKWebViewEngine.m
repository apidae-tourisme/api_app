...
/* File patched to enable focus on input fields (programmatically) - see updateSettings method below */
...
- (void)updateSettings:(NSDictionary*)settings
{
    ...
    // Enabling focus on text inputs without user action
    // See https://issues.apache.org/jira/browse/CB-10376 for Cordova issue
    // See https://github.com/Telerik-Verified-Plugins/WKWebView/commit/04e8296adeb61f289f9c698045c19b62d080c7e3 for original fix by Telerik
    BOOL keyboardDisplayRequiresUserAction = ([settings cordovaBoolSettingForKey:@"KeyboardDisplayRequiresUserAction" defaultValue:NO]);
